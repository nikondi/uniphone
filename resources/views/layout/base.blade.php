    ...
    <svg width="238" height="96" viewBox="0 0 238 96" fill="none" xmlns="http://www.w3.org/2000/svg" class="preloader__image">
        <defs>
            <clipPath id="preloader-svg-clip" clipPathUnits="userSpaceOnUse">
                ...
                <path d="M73 35V64.6285H76.7222V35.0089C76.3425 35.6085 75.6714 36.0069 74.9069 36.0069C74.1423 36.0069 73.4713 35.6085 73.0916 35.0089Z"/>
        ...
        <path d="M122.5 35C121 36 119.965 37.6994 119 38.7818V0H122.41L122.5 35Z" fill="#636363" class="preloader-svg-gray"/>
        <path d="M146.233 51.476V64.4133H149.865V59.0066C148.075 56.8776 146.801 54.3039 146.233 51.476Z" fill="#636363" class="preloader-svg-gray"/>
        ...
        <path d="M33.0084 51.476V64.4133H29.3774V59.0066C31.167 56.8776 32.4412 54.3039 33.0084 51.476Z" fill="#636363" class="preloader-svg-gray"/>
        <path d="M29.3774 44.4525V31.5152H33.0084V36.9222C31.2189 39.0505 29.9448 41.6244 29.3774 44.4525Z" fill="#636363" class="preloader-svg-gray"/>
        <path d="M204.989 51.476V64.4133H208.621V59.0066C206.831 56.8776 205.556 54.3039 204.989 51.476Z" fill="#636363" class="preloader-svg-gray"/>
        <path d="M179.242 51.476V64.4133H175.612V59.0066C177.402 56.8776 178.675 54.3039 179.242 51.476Z" fill="#636363" class="preloader-svg-gray"/>
        <path d="M177.223 40.0725C174.42 34.9727 168.984 31.5152 162.738 31.5152C156.51 31.5152 151.087 34.9533 148.278 40.0291C149.191 41.7647 149.808 43.6791 150.063 45.7067C151.133 39.6973 156.402 35.1339 162.738 35.1339C169.086 35.1339 174.361 39.7125 175.419 45.737C175.679 43.7129 176.303 41.802 177.223 40.0725Z" fill="#636363" class="preloader-svg-gray"/>
        ...
        <path d="M207.033 40.0291C207.947 41.7647 208.564 43.6791 208.819 45.7064C209.889 39.6972 215.157 35.1339 221.494 35.1339C228.604 35.1339 234.368 40.8785 234.368 47.9644H237.999C237.999 38.8799 230.609 31.5152 221.494 31.5152C215.266 31.5152 209.843 34.9533 207.033 40.0291Z" fill="#636363" class="preloader-svg-gray"/>
        <path d="M208.951 45.9903H237.674L238 47.7999V49.6091H209.116L208.951 45.9903Z" fill="#636363" class="preloader-svg-gray"/>

        <circle cx="75.2" cy="33.3" fill="#246BFD" r="1.815" id="preloader-svg-dot"/>
